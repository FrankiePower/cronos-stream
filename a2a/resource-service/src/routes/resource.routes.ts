 ...
 *
 * Settlement endpoint for streaming (channel-based) payments via CronosStream Sequencer.
 *
 * Delegates processing to {@link ResourceController.payVoucher}.
 */
router.post('/pay-voucher', controller.payVoucher.bind(controller));
